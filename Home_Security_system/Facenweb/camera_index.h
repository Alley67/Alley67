...
<title>Home security Face Recognition</title>
<style>
...
<div id="content-right">
  ...
  <div class="buttons">
    ...
    <button id="button-detect" class="right">DETECT PERSON</button>
  </div>
  <div class="buttons">
    <button id="button-capture" class="left" title="Enter a name above before capturing a face">ADD PERSON</button>
    <button id="button-recognise" class="right">RECOGNISE PERSON</button>
  </div>
  <div class="people">
